...
- 服务键 `balance` 同时是 Typert namespace；`typert-host.js` 是手写 strict manifest。
...
- `README.md` 面向用户；`UI设计构思.md` 设计规范；`开发计划.md`、`排障记录.md` 为本地文档（gitignore）。
